...
# 1. Instalación de dependencias y parches JAXB para compatibilidad con Spring Boot 1.5 en Java 11
...
# 3. Preparar estructura de la web y compilar Servlets con Jakarta
...
RUN chmod +x lanzaCentroEducativo.sh poblar_centro_educativo.sh && \
    ...
    # Puerto falso para engañar al Health Check de Koyeb
    ...
    echo 'EOF' >> start.sh && \
    # Lanzamiento de API con parches JAXB
